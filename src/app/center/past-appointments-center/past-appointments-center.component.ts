...
@Component({
  selector: 'app-past-appointments-center',
  templateUrl: './past-appointments-center.component.html',
  styleUrls: ['./past-appointments-center.component.css']
})
export class PastAppointmentsCenterComponent implements OnInit {
