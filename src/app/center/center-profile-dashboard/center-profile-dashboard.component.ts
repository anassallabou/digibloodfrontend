...
@Component({
  selector: 'app-center-profile-dashboard',
  templateUrl: './center-profile-dashboard.component.html',
  styleUrls: ['./center-profile-dashboard.component.css'],
  animations: [
...
export class CenterProfileDashboardComponent implements OnInit {
